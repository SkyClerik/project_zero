...
- [ ] Установить цвет подсветки требования
...
- [ ] Исправить баг переноса из экипировки в экипировку
- [ ] По возможности инкапсулировать каждый Page от ItemsPage
- [ ] Положить этот API в проект 
