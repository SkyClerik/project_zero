...
{
    public class ArmorDetailPanel : VisualElement
    {
        private SerializedObject _currentSerializedObject;
        private ArmorDefinition _currentDefinition;
        ...
        public ArmorDetailPanel(Action onDefinitionNameChangedCallback)
        {
        ...
        {
            Clear();
            _currentDefinition = selected as ArmorDefinition;
            ...
            {
                Add(new Label("Выберите броню для редактирования.")
                {
