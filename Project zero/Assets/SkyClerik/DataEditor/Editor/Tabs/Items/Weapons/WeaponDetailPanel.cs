...
{
    public class WeaponDetailPanel : VisualElement
    {
        ...
        public WeaponDetailPanel(Action onDefinitionNameChangedCallback)
        {
        ...
        {
            Clear();
            _currentDefinition = selected as WeaponDefinition;
            ...
            {
                Add(new Label("Выберите оружие для редактирования.")
                {
