...
{
    public class ConsumableItemDetailPanel : VisualElement
    {
        private Action _onDefinitionNameChangedCallback;
        private ConsumableItemDefinition _currentDefinition;
        ...
        public ConsumableItemDetailPanel(Action onDefinitionNameChangedCallback)
        {
        ...
        public void DisplayDetails(BaseDefinition selected)
        {
            ...
            {
                Add(new Label("Выберите обычный предмет из списка для редактирования.")
                {
            ...
            if (hasVisibleProperties)
            {
                do
                {
                    ...
                    {
                        // Специальная логика для ConsumableItemDetailPanel
                        // if (_currentDefinition is ConsumableItemDefinition && propertyIterator.name == "SomeSpecificField")
                        // {
